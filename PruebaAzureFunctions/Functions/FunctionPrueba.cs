...
namespace PruebaAzureFunctions.Functions
{
    public class FunctionPrueba
    {
        ...
        public FunctionPrueba(IEmailService emailService)
        {
        ...
        {
            var logger = context.GetLogger("FunctionPrueba");
            ...
            try
            {
                ...
                logger.LogInformation($"Enviando positivo correo a {rqObject.toEmail} con asunto: {rqObject.subject}");
